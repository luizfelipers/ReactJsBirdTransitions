# React Js Page Transitions - Framer Motion

An example project, done after following Brian Design's tutorial on youtube about Framer Motion's transitions between pages.
This is the first step to an open-source project I'll host, mainly to contribute with the animal cause in Brazil.
